...
public class MainActivityRecyclerViewTest {
    ...
    public void mainActivityTest() {
        ...
        recipesRecyclerView.perform(actionOnItemAtPosition(1, click()));
        ...
        ViewInteraction stepsRecyclerView = onView(
                allOf(withId(R.id.recyclerViewSteps), isDisplayed()));
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.textViewNext), withText("Next"), isDisplayed()));
        ...
        ViewInteraction appCompatTextView2 = onView(
                allOf(withId(R.id.textViewPrevious), withText("Previous"), isDisplayed()));
